...
Due to $\frac{3}{2} \geq 0$ and $\frac{3}{2}$ being a constant, the Limit Theorem states that $\lim_{n \rightarrow \infty} \frac{\frac{3}{2}n^2 + \frac{17}{2}n} + 12  \in O(n^2)$ <br />
